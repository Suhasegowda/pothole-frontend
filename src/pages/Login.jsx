        ...
        <div className="glass w-full max-w-6xl rounded-3xl overflow-hidden grid md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col justify-center items-center text-white p-14 relative">
            ...
            <img 
              ...
              alt="CivicLens" 
              className="w-72 mt-8 drop-shadow-lg rounded-2xl" 
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="mb-6">
                ...
                <input 
                  ...
                  className="input-box w-full px-5 py-4 rounded-2xl border border-gray-300 outline-none text-slate-800" 
                />
              </div>
              ...
              <button 
                type="submit"
                className="login-btn w-full bg-gradient-to-r from-sky-500 to-cyan-400 text-white py-4 rounded-2xl font-bold text-lg"
              >
                Login
              </button>
            </form>
